...
"undefined" != typeof jQuery && ($ = jQuery.noConflict()),
  (function (e, t) {
    ...
    var s = {
      ...
      a =
          ...
          (s = Object.assign({}, s, cnvsOptions)),
        {
          ...
          get tips() {
            var e = this.elBody.getAttribute("data-tips") || s.tips;
            return "true" == e || !0 === e;
          },
          get smoothScroll() {
            var e =
              this.elBody.getAttribute("data-smooth-scroll") || s.smoothScroll;
            return "true" == e || !0 === e;
          },
          get isRTL() {
      ...
      l = {
        ...
        breakpoints: function () {
          ...
          Object.keys(n).forEach(function (e) {
            t > n[e].enter && t <= n[e].exit
              ? a.elBody.classList.add("device-" + e)
              : (a.elBody.classList.remove("device-" + e),
                "" != r && a.elBody.classList.remove("device-down-" + r)),
              t <= n[e].exit &&
                "" != r &&
                a.elBody.classList.add("device-down-" + r),
              t > n[(r = e)].enter
                ? a.elBody.classList.add("device-up-" + e)
                : a.elBody.classList.remove("device-up-" + e);
          });
        },
        colorScheme: function () {
          a.elBody.classList.contains("adaptive-color-scheme") &&
            (window.matchMedia("(prefers-color-scheme: dark)").matches
              ? a.elBody.classList.add("dark")
              : a.elBody.classList.remove("dark"));
          var e = l.cookie.get("__cnvs_body_color_scheme");
          e &&
            "" != e &&
        ...
        debounce: function (e, t) {
          clearTimeout(a.debounced), (a.debounced = setTimeout(e, t));
        },
        ...
        viewport: function () {
          var e = {
            width: window.innerWidth || a.elRoot.clientWidth,
            height: window.innerHeight || a.elRoot.clientHeight,
          };
          return (
            (a.viewport = e),
          ...
          return (
            t
              ...
              : l.isElement(e) ||
                (e = n
                  ? "string" == typeof n
                    ? l.getVars.baseEl.querySelectorAll(e + ":not(" + n + ")")
        ...
        contains: function (e, t) {
          ...
          return (
            e.forEach(function (e) {
              a.elBody.classList.contains(e) && (n = !0);
            }),
            n
          );
        },
        ...
        scrollTo: function (e = 0, t = 1250, n, r = "smooth") {
          var o, i, u;
          n &&
          ...
          void 0 !== jQuery.easing.easeOutQuad
            ? jQuery("body,html")
                .stop(!0)
                .animate({ scrollTop: Number(e) }, Number(t), n)
            : ((t = "scrollBehavior" in document.documentElement.style),
              "function" == typeof window.scroll && t
                ? window.scroll({ top: Number(e), behavior: r })
                : ((o = l.getVars.elBody),
                  (i = l.getVars.elRoot),
                  o.scrollIntoView(),
                  i.scrollIntoView(),
                  (u = function () {
                    (o.scrollTop > Number(e) || i.scrollTop > Number(e)) &&
                      ((o.scrollTop -= 20),
                      (i.scrollTop -= 20),
                      setTimeout(u, 10));
                  })()));
        ...
        smoothScroll: function () {
          function e(e) {
            ...
            e = (e = e).detail
              ...
              : e.wheelDelta / 120;
            (u += -e * r),
              (u = Math.max(0, Math.min(u, n.scrollHeight - l.clientHeight))),
              i || t();
          }
          function t() {
            i = !0;
            var e = (u - n.scrollTop) / o;
            (n.scrollTop += e), 0.5 < Math.abs(e) ? s(t) : (i = !1);
          }
          var n, r, o, i, u, l, s;
          (n = document),
            (r = 90),
            ...
            (l =
              n === document.body && document.documentElement
                ? document.documentElement
                : n),
            n.addEventListener("mousewheel", e, { passive: !1 }),
            n.addEventListener("DOMMouseScroll", e, { passive: !1 }),
            (s =
        ...
        loadCSS: function (e) {
          ...
          return (
            ...
            !(
              ...
              (t.href = e ? s.cssFolder + n : n),
              (t.rel = "stylesheet"),
              (t.type = "text/css"),
              a.elHead.appendChild(t),
              0)
            )
          );
        },
        loadJS: function (e) {
          ...
          return (
            (l.id = n),
            (l.src = e ? s.jsFolder + t : t),
            r && (l.type = r),
            (l.async = !!i),
            (l.defer = !!u),
            a.elBody.appendChild(l),
            !0
          );
        },
        ...
        initFunction: function (e) {
          a.elBody.classList.add(e.class),
        ...
        runModule: function (t) {
          ...
          var n = t.plugin.toLowerCase(),
            r = s.jsFolder + "modules/" + n + ".js";
          t.file && (r = t.file);
          return (
            e()
              ? CNVS[t.plugin].init(t.selector)
              : (l.loadJS({ file: r, id: "canvas-" + n + "-fn" }),
                l.isFuncTrue(e).then(function (e) {
                  if (!e) return !1;
                  CNVS[t.plugin].init(t.selector);
                })),
            !0
        ...
        topScrollOffset: function () {
          var e = 0,
            t =
              a.elPageMenu?.querySelector("#page-menu-wrap")?.offsetHeight || 0;
          a.elBody.classList.contains("is-expanded-menu") &&
            (a.elHeader?.classList.contains("sticky-header") &&
              (e = a.elHeaderWrap.offsetHeight),
            (!a.elPageMenu?.classList.contains("dots-menu") &&
              a.elPageMenu?.classList.contains("sticky-page-menu")) ||
              (t = 0)),
            (l.getVars.topScrollOffset = e + t + s.scrollOffset);
        },
      },
      e = {
        init: function () {
          n.any() && a.elBody.classList.add("device-touch");
        },
        menuBreakpoint: function () {
          l.getVars.menuBreakpoint <= l.viewport().width
            ? a.elBody.classList.add("is-expanded-menu")
            : a.elBody.classList.remove("is-expanded-menu"),
            a.elPageMenu &&
              ...
              l.getVars.pageMenuBreakpoint <= l.viewport().width
                ? a.elBody.classList.add("is-expanded-pagemenu")
                : a.elBody.classList.remove("is-expanded-pagemenu"));
        },
        goToTop: function () {
          return l.initModule({ selector: "#gotoTop", plugin: "GoToTop" });
        },
        ...
        logo: function () {
          return l.initModule({ selector: "#logo", plugin: "Logo" });
        },
        headers: function () {
          return (
            (l.getVars.headerClasses = a.elHeader?.className || ""),
            (l.getVars.headerWrapClasses = a.elHeaderWrap?.className || ""),
            l.initModule({ selector: "#header", plugin: "Headers" })
          );
        },
        menus: function () {
          return l.initModule({ selector: "#header", plugin: "Menus" });
        },
        pageMenu: function () {
          return l.initModule({ selector: "#page-menu", plugin: "PageMenu" });
        },
        ...
        topCart: function () {
          return l.initModule({ selector: "#top-cart", plugin: "TopCart" });
        },
        sidePanel: function () {
          return l.initModule({ selector: "#side-panel", plugin: "SidePanel" });
        },
        ...
        setBSTheme: function () {
          a.elBody.classList.contains("dark")
            ? document
                .querySelector("html")
            ...
            a.elBody.querySelectorAll(".not-dark")?.forEach(function (e) {
      ...
      t = {
        ...
        pricingSwitcher: function (e) {
          return l.initModule({
            selector: e || ".pricing-tenure-switcher",
        ...
        tips: function () {
          if (a.tips) return l.initModule({ selector: "body", plugin: "Tips" });
        },
        textSplitter: function (e) {
          return l.initModule({
            selector: e || ".text-splitter",
            plugin: "TextSplitter",
          });
        },
        mediaActions: function (e) {
          return l.initModule({
            selector: e || ".media-wrap",
            plugin: "MediaActions",
          });
        },
        ...
        scrollDetect: function (e) {
          return l.initModule({
            selector: e || ".scroll-detect",
            plugin: "ScrollDetect",
          });
        },
        fontSizer: function (e) {
          return l.initModule({
            selector: e || ".font-sizer",
            plugin: "FontSizer",
          });
        },
        hover3D: function (e) {
          ...
          fetch("switcher-html.html")
            ...
            .then((e) => {
              ...
              t.classList.add("cnvs-switcher-container"),
                (t.innerHTML = e),
                a.elBody.appendChild(t),
                l.runContainerModules(t),
                l.loadJS({
      ...
      i = {
        init: function () {
          l.breakpoints(),
            ...
            l.runModules(),
            l.topScrollOffset(),
            a.smoothScroll && new l.smoothScroll(),
            i.windowscroll(),
            r.onReady();
        },
    ...
    return (
      ...
      { Core: l, Base: e, Modules: t, Mobile: n, Custom: r }
    );
  }),
  (function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
